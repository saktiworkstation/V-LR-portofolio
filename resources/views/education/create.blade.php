                        ...
                        <form method="POST" action="{{ route('education') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="field_of_study" name="field_of_study" type="text"
                                    class="mt-1 block w-full" :value="old('field_of_study')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="education_name" name="education_name" type="text"
                                    class="mt-1 block w-full" :value="old('education_name')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="graduation_year" name="graduation_year" type="text"
                                    class="mt-1 block w-full" :value="old('graduation_year')" required autofocus
