...
<section class="py-10 md:py-16">
    ...
    <div data-aos="fade-in" class="container max-w-screen-xl mx-auto px-4">
        ...
        <h1 class="font-medium text-dark text-3xl md:text-4xl mb-5 animate-bounce">Experience</h1>
        ...
        @foreach ($experiences as $item)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div data-aos="flip-left"
                    ...
                    <p class="font-normal text-gray-500 text-md mb-4">Field : {{ $item->field }}</p>

                    <div class="relative">
                        <h6 class="font-semibold text-gray-500 text-md relative z-10">{{ $item->company }}</h6>
