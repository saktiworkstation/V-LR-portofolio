  ...
  <div class="mx-auto w-[80%] py-10 text-center md:text-left pt-72">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="px-10 ">
        ...
        including creating a CV, 
        so that you can continue your productivity.
        </p>
      </div>
      <!-- Products section -->
      <div class="px-10">
        ...
        <p class="mb-4 text-start">
          <a href="#!">Ask for references</a>
        </p>
        <p class="mb-4 text-start">
          <a href="#!">Update Personal</a>
        </p>
         <p class=" text-start">
          <a href="#!">Check your dashboard</a>
        </p>
      </div>
