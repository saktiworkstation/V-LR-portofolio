...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="mb-32">
    <h2 class="mb-10 text-center text-3xl font-bold"><u>Latest Project</u></h2>
    ...
    <div class="p-8 flex flex-wrap ">
      ...
      <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
        ...
        <p class="mb-6 text-sm text-neutral-500 dark:text-neutral-500">
          Created at <u>14.01.2022</u> 
        </p>
        <p class="mb-6 text-neutral-500 dark:text-neutral-900 text-lg">
          Ut pretium ultricies dignissim. Sed sit amet mi eget urna placerat
          vulputate. Ut vulputate est non quam dignissim elementum. Donec a
          ullamcorper diam. Lorem ipsum dolor sit amet consectetur adipisicing elit. 
        </p>
        <button
        type="button"
    ...
    <div class=" p-8 flex flex-wrap lg:flex-row-reverse bg-indigo-50">
         <div class=" flex-none lg:w-1/12"></div>
      ...
      <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
        ...
        <p class=" mb-6 text-neutral-500 dark:text-neutral-900 text-lg">
          ...
          vitae, sodales vestibulum purus. 
        </p>
        <button
        type="button"
        class="inline-block rounded bg-neutral-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-neutral-50 shadow-dark-3 transition duration-150 ease-in-out hover:bg-neutral-700 hover:shadow-dark-2 focus:bg-neutral-700 focus:shadow-dark-2 focus:outline-none focus:ring-0 active:bg-neutral-900 active:shadow-dark-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong">
